...
public class ThirdPersonCharacter : MonoBehaviour
{
	...
	[SerializeField] float m_MoveSpeedSprintMultiplier = 2f;
	[SerializeField] float m_AnimSpeedSprintMultiplier = 2f;
	...
	public void Move(Vector3 move, bool crouch, bool jump, bool sprint)
	{
		...
		// Set speed based on whether sprinting or not
		if (sprint) {
			m_MoveSpeedMultiplier = m_MoveSpeedSprintMultiplier;
			m_AnimSpeedMultiplier = m_AnimSpeedSprintMultiplier;
		} else {
